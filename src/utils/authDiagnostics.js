...
import { firebaseConfig, getFirebaseConfigSummary, googleOAuthConfig, getNodeApiUrl } from '../services/env';
import { isExpoGoClient } from '../features/auth/googleAuthConfig';
...
export function getStartupDiagnostics() {
  ...
  return {
    firebase: getFirebaseConfigSummary(),
