export const API_ENDPOINTS = {
  ...
  buyerDeals: '/api/buyer/deals',
  buyerDeal: (id) => `/api/buyer/deals/${id}`,
  buyerDealResubmit: (id) => `/api/buyer/deals/${id}/resubmit`,
  buyerDealCounter: (id) => `/api/buyer/deals/${id}/counter`,
  buyerDealAcceptCounter: (id) => `/api/buyer/deals/${id}/accept-counter`,
